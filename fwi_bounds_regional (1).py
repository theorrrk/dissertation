...
def main():
    ...
    model_fwi = np.empty((6,49,17,100)) 
    for k in range(1,49):
        print(f'Model {k}')
        ...
        for j in range(17):
            ...
            for i in range(100):
                ...
                fwi_model_ijk_data = np.load(f'/data/met/fwi/ukcordex_new_fwi_{k+1}.npy')[0,summer_indices,:,:]
    ...
    np.save(f'/home/theo/outdata/2.1.outdata/ukcordex_regional_fwi_severity_by_area',model_fwi)
